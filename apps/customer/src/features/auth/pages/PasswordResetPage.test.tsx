...
describe('PasswordResetPage', () => {
  ...
  it('소셜_전용_계정은_차단되고_카카오_안내', async () => {
    const user = userEvent.setup()
    ...
    expect(await screen.findByText(/카카오로/)).toBeInTheDocument()
    // 새 비밀번호 단계로 넘어가지 않음
    expect(screen.queryByPlaceholderText('새 비밀번호 입력')).not.toBeInTheDocument()
  })
