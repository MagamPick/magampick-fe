...
import { Step4Name } from '../components/Step4Name'
import { Step5Store } from '../components/Step5Store'
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col bg-card">
      <header className="flex h-14 shrink-0 items-center gap-1 border-b border-border px-2">
        ...
        <span className="text-[17px] font-bold tracking-tight text-foreground">사장님 회원가입</span>
      </header>
