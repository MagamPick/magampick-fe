...
describe('BizStatusSheet — 영업 상태 관리 시트', () => {
  it('OPEN 상태면 잠시 휴식·오늘 영업 종료 액션을 노출', () => {
    renderSheet({ storeId: 's1', operationStatus: 'OPEN', canOpenToday: true, todayCloseTime: '21:00' })
  ...
  it('휴무일(canOpenToday=false)이면 영업 시작이 비활성 + 사유를 보여준다', () => {
    renderSheet({ storeId: 's2', operationStatus: 'CLOSED_TODAY', canOpenToday: false })
